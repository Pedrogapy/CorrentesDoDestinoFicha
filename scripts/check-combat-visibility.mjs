...
assert(combat.includes('Ordem de iniciativa visÃ­vel'), 'Jogador precisa ver iniciativa apenas das entidades reveladas.');
...
console.log('OK: seleÃ§Ã£o inicial, pesquisa, entrada no meio do combate, iniciativa visÃ­vel e trava de alvos validadas para v0.8.2.');
